...
services:
  ...
  fasefood-api:
    ...
    container_name: fasefood-api
    ports:
      - "8080:8080"
    depends_on:
      - h2-database
    environment:
      - SPRING_DATASOURCE_URL=jdbc:h2:tcp://h2-database:1521/fasefood
      - SPRING_DATASOURCE_USERNAME=admin
      - SPRING_DATASOURCE_PASSWORD=admin
      - SPRING_DATASOURCE_DRIVER_CLASS_NAME=org.h2.Driver
      - SPRING_H2_CONSOLE_ENABLED=true
      - FASEFOOD_OPENAPI_DEV_URL=http://localhost:8080
    networks:
      - fasefood-network
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/MSFelisberto/fasefood.git
   cd fasefood
   ```
...
3. Acesse as interfaces:
   ...
   - H2 Console: http://localhost:8080/h2-console (ou http://localhost:8082)
     - JDBC URL: jdbc:h2:tcp://h2-database:1521/fasefood
     - Usuário: admin
     - Senha: admin
...
A collection do Postman está disponível no repositório, no arquivo `FaseFood.postman_collection.json`.

### Como importar e usar a collection:

1. Abra o Postman
2. Clique em "Import" no canto superior esquerdo
3. Arraste o arquivo `FaseFood.postman_collection.json` ou navegue até ele
...
O código completo está disponível em: [https://github.com/MSFelisberto/fasefood](https://github.com/MSFelisberto/fasefood)
